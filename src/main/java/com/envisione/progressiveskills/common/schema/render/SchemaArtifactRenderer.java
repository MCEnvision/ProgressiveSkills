...
public final class SchemaArtifactRenderer {
    ...
    public static String referenceMarkdown(SchemaRegistry registry) {
        ...
        output.append("# ProgressiveSkills Schema Reference v")
                ...
                .append("Schema v2 includes the shared immutable IR, authoring schemas, and internal runtime contracts implemented through Phase 7. Gameplay definition schemas arrive with their implementation phases.\n\n");
