...
Status: locked and executed by the Phase 16 hardening workload. Threshold changes require an ADR containing before and after profiles and the reason for the change.
